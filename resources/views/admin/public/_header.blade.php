<div class="layui-header">
    <a href="{{ route('admin.dashboard') }}" class="layui-logo" id="layui-logo">{{ config('app.name') }}</a>
...
<script>
    document.querySelector('#changePassword').addEventListener('click', function (e) {
        layer.prompt({
            ...
            axios.patch('{{ route('admin.password', Auth::id()) }}', {password: password}).then(function (response) {
